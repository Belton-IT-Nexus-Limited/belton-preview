    ...
    <>
      ...
      <section
        className={cn(
          ...
          'before:absolute before:inset-0 before:bg-[url(/images/belton-house.webp)]',
          'before:bg-cover before:bg-center before:opacity-[0.08] before:grayscale before:contrast-110',
